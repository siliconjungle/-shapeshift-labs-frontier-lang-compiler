...
export function routeSemanticEditBundle(route) {
  ...
  return compactRecord({
    ...
    semanticTransformIdentity: firstDefined(route.semanticTransformIdentity, metadata.semanticTransformIdentity, semanticEdit.semanticTransformIdentity, semanticEdit.transform),
    semanticTransformIdentities: firstDefined(route.semanticTransformIdentities, metadata.semanticTransformIdentities, semanticEdit.semanticTransformIdentities, semanticEdit.transforms),
    semanticTransforms: firstDefined(route.semanticTransforms, metadata.semanticTransforms, semanticEdit.semanticTransforms),
