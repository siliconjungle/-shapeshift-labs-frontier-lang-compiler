...
export interface NativeProjectSymbolGraphJsxPropRecord {
  ...
  readonly propValueProofStatus?: string; readonly propValueReasonCode?: string; readonly propValueKind?: string; readonly propValueText?: string; readonly propValueExpressionText?: string; readonly propValueReferenceRoot?: string; readonly propValueReferencePath?: readonly string[]; readonly propValueOptionalReference?: boolean; readonly propValueOptionalReferenceSegments?: readonly string[]; readonly propValueOptionalReferenceSegmentIndexes?: readonly number[]; readonly propValueOptionalNullishBoundaryCount?: number; readonly propValueStaticStyleObjectProofStatus?: string; readonly propValueStaticStyleObjectEntries?: readonly NativeProjectSymbolGraphJsxStyleObjectEntry[]; readonly propValueStaticStyleObjectPropertyNames?: readonly string[]; readonly propValueStaticStyleObjectPropertyCount?: number; readonly propValueStaticStyleObjectDuplicatePropertyNames?: readonly string[]; readonly propValueStaticStyleObjectClaimScope?: string; readonly propValueStaticStyleObjectRenderEquivalenceClaim?: false | boolean; readonly propValueDynamicText?: string; readonly propValueDynamicBlockerReasonCode?: string; readonly propValueExpressionHash?: string; readonly propValueSignatureHash?: string;
...
export interface NativeProjectSymbolGraphJsxStyleObjectEntry { readonly stylePropertyName: string; readonly keyText?: string; readonly valueKind?: string; readonly valueText?: string; readonly ordinal?: number; readonly entryHash?: string; }
