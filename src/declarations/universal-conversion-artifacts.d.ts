...
export interface UniversalConversionAdmissionRecord {
  ...
  readonly moduleConstraintStatus?: string; readonly numericSemanticsConstraintStatus?: string; readonly objectModelConstraintStatus?: string; readonly protocolConstraintStatus?: string;
  readonly moduleConstraintAction?: string; readonly numericSemanticsConstraintAction?: string; readonly objectModelConstraintAction?: string; readonly protocolConstraintAction?: string;
