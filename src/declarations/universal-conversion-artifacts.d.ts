...
export interface CreateUniversalConversionArtifactsOptions extends UniversalConversionRouteDialectQuery {
  ...
  readonly translationRuntimeReadiness?: string | readonly string[]; readonly translationRuntimeAdapterRequirementId?: string | readonly string[]; readonly translationRuntimeProofObligationId?: string | readonly string[]; readonly translationRuntimeProofCapability?: UniversalRuntimeCapabilityKind | readonly UniversalRuntimeCapabilityKind[]; readonly translationRuntimeProofStatus?: string | readonly string[]; readonly translationRuntimeProofRequiredSignal?: UniversalRuntimeProofSignalKind | readonly UniversalRuntimeProofSignalKind[]; readonly translationRuntimeProofProvidedSignal?: UniversalRuntimeProofSignalKind | readonly UniversalRuntimeProofSignalKind[]; readonly translationRuntimeProofMissingSignal?: UniversalRuntimeProofSignalKind | readonly UniversalRuntimeProofSignalKind[]; readonly translationDialectReadiness?: string | readonly string[]; readonly translationDialectRecordId?: string | readonly string[];
