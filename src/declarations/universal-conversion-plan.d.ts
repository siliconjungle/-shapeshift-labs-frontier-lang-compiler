...
export interface UniversalConversionPlanQuery extends URCQ, UniversalInterlinguaQuery, ResQ, LtQ, CfQ, AdtQ, BsQ, BcQ, DlQ, EfQ, ConQ, ErrQ, EvalQ, HostQ, MemQ, MetaQ, SbQ, ModQ, NumQ, TxtQ, ColQ, ObjQ, ProtoQ, TyQ {
  readonly sourceLanguage?: SL | string;
