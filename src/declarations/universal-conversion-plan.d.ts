...
import type { UniversalEffectConstraintEvidence, UniversalEffectConstraintInput, UniversalEffectConstraintQuery } from './universal-effect-constraints.js'; import type { UniversalErrorModelConstraintEvidence as ErrEv, UniversalErrorModelConstraintInput as ErrIn, UniversalErrorModelConstraintQuery as ErrQ } from './universal-error-model-constraints.js';
import type { UniversalLifetimeConstraintEvidence, UniversalLifetimeConstraintInput, UniversalLifetimeConstraintQuery } from './universal-lifetime-constraints.js'; import type { UniversalMemoryModelConstraintEvidence, UniversalMemoryModelConstraintInput, UniversalMemoryModelConstraintQuery } from './universal-memory-model-constraints.js';
...
export interface UniversalTranslationConstraintSummary { readonly id?: string; readonly status?: string; readonly action?: string; readonly requiredKinds: readonly string[]; readonly representedKinds: readonly string[]; readonly missingKinds: readonly string[]; readonly missingEvidence: readonly string[]; }
export interface UniversalTranslationAdmission {
  ...
  readonly resourceTransfer?: Omit<UniversalTranslationConstraintSummary, 'missingEvidence'> & { readonly losses: readonly string[]; readonly ownershipConstraints?: UniversalTranslationConstraintSummary };
  ...
  readonly lifetimeConstraint?: UniversalTranslationConstraintSummary; readonly lifetimeConstraintStatus?: string; readonly lifetimeConstraintAction?: string; readonly lifetimeConstraintMissingEvidence: readonly string[];
  readonly controlFlowConstraint?: UniversalTranslationConstraintSummary; readonly controlFlowConstraintStatus?: string; readonly controlFlowConstraintAction?: string; readonly controlFlowConstraintMissingEvidence: readonly string[];
  readonly borrowScopeConstraint?: UniversalTranslationConstraintSummary; readonly borrowScopeConstraintStatus?: string; readonly borrowScopeConstraintAction?: string; readonly borrowScopeConstraintMissingEvidence: readonly string[];
  readonly borrowCheckerConstraint?: UniversalTranslationConstraintSummary; readonly borrowCheckerConstraintStatus?: string; readonly borrowCheckerConstraintAction?: string; readonly borrowCheckerConstraintMissingEvidence: readonly string[];
  readonly effectConstraint?: UniversalTranslationConstraintSummary; readonly effectConstraintStatus?: string; readonly effectConstraintAction?: string; readonly effectConstraintMissingEvidence: readonly string[]; readonly errorModelConstraint?: UniversalTranslationConstraintSummary; readonly errorModelConstraintStatus?: string; readonly errorModelConstraintAction?: string; readonly errorModelConstraintMissingEvidence: readonly string[]; readonly memoryModelConstraint?: UniversalTranslationConstraintSummary; readonly memoryModelConstraintStatus?: string; readonly memoryModelConstraintAction?: string; readonly memoryModelConstraintMissingEvidence: readonly string[];
  readonly moduleConstraint?: UniversalTranslationConstraintSummary; readonly moduleConstraintStatus?: string; readonly moduleConstraintAction?: string; readonly moduleConstraintMissingEvidence: readonly string[];
  readonly typeConstraint?: UniversalTranslationConstraintSummary; readonly typeConstraintStatus?: string; readonly typeConstraintAction?: string; readonly typeConstraintMissingEvidence: readonly string[];
...
export interface UniversalConversionPlanOptions extends UniversalCapabilityMatrixOptions {
  ...
  readonly effectConstraint?: UniversalEffectConstraintInput | UniversalEffectConstraintEvidence; readonly translationEffectConstraint?: UniversalEffectConstraintInput | UniversalEffectConstraintEvidence; readonly effectConstraints?: readonly (UniversalEffectConstraintInput | UniversalEffectConstraintEvidence)[]; readonly errorModelConstraint?: ErrIn | ErrEv; readonly translationErrorModelConstraint?: ErrIn | ErrEv; readonly errorModelConstraints?: readonly (ErrIn | ErrEv)[]; readonly memoryModelConstraint?: UniversalMemoryModelConstraintInput | UniversalMemoryModelConstraintEvidence; readonly translationMemoryModelConstraint?: UniversalMemoryModelConstraintInput | UniversalMemoryModelConstraintEvidence; readonly memoryModelConstraints?: readonly (UniversalMemoryModelConstraintInput | UniversalMemoryModelConstraintEvidence)[];
