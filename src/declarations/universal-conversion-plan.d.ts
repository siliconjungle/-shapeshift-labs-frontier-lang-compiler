...
export interface UniversalTranslationAdmission {
  ...
  readonly effectConstraint?: UniversalTranslationConstraintSummary; readonly effectConstraintStatus?: string; readonly effectConstraintAction?: string; readonly effectConstraintMissingEvidence: readonly string[];
