...
import type { UniversalRuntimeCapabilityKind as URK, UniversalRuntimeProofSignalKind as UPS } from './universal-runtime-capabilities.js';
...
export interface UniversalConversionWorkItem extends UniversalConversionWorklistRuntimeRouteFields, UniversalConversionWorklistSourceMapFields, UniversalConversionWorklistSemanticEditFields, UniversalConversionRouteDialectFields, UniversalConversionConstraintSpaceFields {
  ...
  readonly translationRuntimeProofCapabilities: readonly URK[]; readonly translationRuntimeProofStatuses: readonly string[];
  readonly translationRuntimeProofRequiredSignals: readonly UPS[]; readonly translationRuntimeProofProvidedSignals: readonly UPS[]; readonly translationRuntimeProofMissingSignals: readonly UPS[];
...
export interface UniversalConversionWorklist {
  ...
  readonly summary: UniversalConversionWorklistSemanticEditFields & UniversalConversionRouteDialectFields & UniversalConversionConstraintSpaceFields & {
    ...
    readonly requiredRuntimeCapabilities: readonly URK[];
    readonly satisfiedRuntimeCapabilities: readonly URK[];
    readonly missingRuntimeCapabilities: readonly URK[];
