...
export interface UniversalConversionLayoutStyleConstraintCompactCounts extends UniversalConversionEffectConstraintCompactCounts {}
...
export interface UniversalConversionArtifactCompactCounts {
  ...
  readonly layoutStyleConstraint: UniversalConversionLayoutStyleConstraintCompactCounts;
