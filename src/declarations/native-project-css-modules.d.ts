...
export interface NativeProjectSymbolGraphCssModuleUseSiteRecord {
  ...
  readonly sourceSpan?: SourceSpan;
  readonly accessKind?: 'dot' | 'static-bracket' | 'static-template' | 'bounded-dynamic-bracket' | 'destructure' | 'named-import' | 'helper-argument' | string;
  ...
  readonly dynamicKeyExpressionText?: string;
  readonly dynamicKeyDomain?: readonly string[];
  readonly dynamicKeyDomainHash?: string;
  readonly dynamicKeyProofLevel?: 'css-module-source-bound-finite-dynamic-key-domain' | string;
  readonly dynamicKeyProofSource?: 'local-type-annotation' | 'local-type-annotation:type-alias' | 'object-property-type-annotation' | 'local-const-object-literal-domain' | 'inline-conditional-literals' | string;
