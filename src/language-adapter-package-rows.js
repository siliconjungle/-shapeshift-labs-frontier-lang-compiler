const packageRows = [
  ...
  row('@shapeshift-labs/frontier-lang-rust', '0.2.11', 'rust', 'rust-syn', { target: 'rust', proofKeys: ['parserAst', 'sourceMap', 'semanticSidecar', 'macroExpansionEvidence'] }),
  row('@shapeshift-labs/frontier-lang-python', '0.2.10', 'python', 'python-ast', { target: 'python', formats: ['python-ast', 'libcst'] }),
  row('@shapeshift-labs/frontier-lang-c', '0.2.10', 'c', 'clang-ast-json', { target: 'c', proofKeys: ['parserAst', 'sourceMap', 'semanticSidecar', 'compileCommandsHash', 'preprocessorRecordsHash'] }),
