...
export function createUniversalConversionAdmissionRecord(input) {
  ...
  return {
    ...
    lifetimeConstraintStatus: route.lifetimeConstraint?.status, lifetimeConstraintAction: route.lifetimeConstraint?.action,
    controlFlowConstraintStatus: route.controlFlowConstraint?.status, controlFlowConstraintAction: route.controlFlowConstraint?.action,
    callableBoundaryConstraintStatus: route.callableBoundaryConstraint?.status, callableBoundaryConstraintAction: route.callableBoundaryConstraint?.action,
    adtPatternConstraintStatus: route.adtPatternConstraint?.status, adtPatternConstraintAction: route.adtPatternConstraint?.action,
    ...
    dataLayoutConstraintStatus: route.dataLayoutConstraint?.status, dataLayoutConstraintAction: route.dataLayoutConstraint?.action,
    layoutStyleConstraintStatus: route.layoutStyleConstraint?.status, layoutStyleConstraintAction: route.layoutStyleConstraint?.action,
    layoutStyleConstraintMissingKinds: route.layoutStyleConstraint?.missingKinds ?? [], layoutStyleConstraintMissingEvidence: route.layoutStyleConstraint?.missingEvidence ?? [],
    ...
    layoutStyleConstraint: constraintRecord(route.layoutStyleConstraint),
    ...
    metadata: {
      ...
      layoutStyleConstraint: route.layoutStyleConstraint,
