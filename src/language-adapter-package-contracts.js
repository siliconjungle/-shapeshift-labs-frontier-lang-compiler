...
const packageRows = [
  row('@shapeshift-labs/frontier-lang-typescript', '0.3.6', 'typescript', 'typescript-compiler-api', { target: 'typescript' }),
  row('@shapeshift-labs/frontier-lang-javascript', '0.2.6', 'javascript', 'estree', { target: 'javascript', formats: ['estree', 'babel'] }),
