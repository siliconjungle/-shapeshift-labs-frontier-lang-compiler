...
export const UniversalInterlinguaLayerKinds = Object.freeze([
  ...
  'numeric-semantics-contract', 'text-semantics-contract', 'collection-semantics-contract',
  'protocol-contract',
  'proof-evidence'
]);
...
export const UniversalInterlinguaConstraintEdgeKinds = Object.freeze([
  ...
  'effect',
  'module',
  'numeric-semantics', 'text-semantics', 'collection-semantics',
  'object-model',
  'protocol',
  'type'
]);
