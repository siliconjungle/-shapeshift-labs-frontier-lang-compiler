...
function packageManagementSummary(files) {
  ...
  return {
    ...
    packageManagerCommandExecutionProofs: proofs.filter((proof) => proof.proofLevel === 'package-manager-command-execution-proof' || proof.packageManagerCommandExecutionProof === true).length,
    ...
    packageManagerCommandExecutionBlockedFiles: countFilesWithReason(packageFiles, 'package-manager-command-execution-proof-missing'),
