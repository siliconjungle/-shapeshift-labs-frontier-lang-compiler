...
const constraintFields = ['lifetimeConstraint', 'controlFlowConstraint', 'callableBoundaryConstraint', 'adtPatternConstraint', 'borrowScopeConstraint', 'borrowCheckerConstraint', 'dataLayoutConstraint', 'layoutStyleConstraint', 'effectConstraint', 'concurrencyModelConstraint', 'errorModelConstraint', 'evaluationModelConstraint', 'hostEnvironmentConstraint', 'memoryModelConstraint', 'metaprogrammingConstraint', 'scopeBindingConstraint', 'moduleConstraint', 'numericSemanticsConstraint', 'textSemanticsConstraint', 'collectionSemanticsConstraint', 'serializationSemanticsConstraint', 'dependencySemanticsConstraint', 'objectModelConstraint', 'protocolConstraint', 'typeConstraint'];
const constraintMatchers = [
  ['lifetimeConstraint', lifetimeConstraintMatches], ['controlFlowConstraint', controlFlowConstraintMatches], ['callableBoundaryConstraint', callableBoundaryConstraintMatches], ['adtPatternConstraint', adtPatternConstraintMatches], ['borrowScopeConstraint', borrowScopeConstraintMatches], ['borrowCheckerConstraint', borrowCheckerConstraintMatches], ['dataLayoutConstraint', dataLayoutConstraintMatches], ['layoutStyleConstraint', layoutStyleConstraintMatches], ['effectConstraint', effectConstraintMatches], ['concurrencyModelConstraint', concurrencyModelConstraintMatches], ['errorModelConstraint', errorModelConstraintMatches], ['evaluationModelConstraint', evaluationModelConstraintMatches], ['hostEnvironmentConstraint', hostEnvironmentConstraintMatches], ['memoryModelConstraint', memoryModelConstraintMatches], ['metaprogrammingConstraint', metaprogrammingConstraintMatches], ['scopeBindingConstraint', scopeBindingConstraintMatches], ['moduleConstraint', moduleConstraintMatches], ['numericSemanticsConstraint', numericSemanticsConstraintMatches], ['textSemanticsConstraint', textSemanticsConstraintMatches], ['collectionSemanticsConstraint', collectionSemanticsConstraintMatches], ['serializationSemanticsConstraint', serializationSemanticsConstraintMatches], ['dependencySemanticsConstraint', dependencySemanticsConstraintMatches], ['objectModelConstraint', objectModelConstraintMatches], ['protocolConstraint', protocolConstraintMatches], ['typeConstraint', typeConstraintMatches]
];
...
function requiredTranslationConstructKinds(input) {
  return uniqueStrings([
    ...
    ...((input.layoutStyleConstraint?.requiredKinds ?? []).length ? ['runtime-capability'] : []),
