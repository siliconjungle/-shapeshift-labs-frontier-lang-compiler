...
assert.match(rustMappedOutput.code, /pub const PERSIST_TODO_EFFECT_CAPABILITY: &str = "storage\.write"/);
assert.match(rustMappedOutput.code, /pub fn run_PersistTodo_effect<E>\(env: &E, input: TodoInput\) -> serde_json::Value/);
assert.match(rustMappedOutput.code, /pub const PERSIST_TODO_EXTERN_SYMBOL: &str = "persistTodo"/);
assert.match(rustMappedOutput.code, /pub const PERSIST_TODO_EXTERN_LANGUAGE: &str = "typescript"/);
assert.match(rustMappedOutput.code, /pub fn call_persistTodo_extern<E>\(env: &E, input: TodoInput\) -> serde_json::Value/);
...
assert.equal(rustMappedOutput.sourceMap.mappings.some((mapping) => mapping.semanticNodeId === 'effect_persist'), true);
assert.equal(rustMappedOutput.sourceMap.mappings.some((mapping) => mapping.semanticNodeId === 'extern_persist'), true);
...
assert.match(pythonMappedOutput.code, /PERSIST_TODO_EFFECT: Mapping\[str, Any\]/);
assert.match(pythonMappedOutput.code, /def run_PersistTodo_effect\(input: TodoInput, env: Mapping\[str, Any\]\) -> Any:/);
assert.match(pythonMappedOutput.code, /PERSIST_TODO_EXTERN: Mapping\[str, Any\]/);
assert.match(pythonMappedOutput.code, /def call_persistTodo_extern\(input: TodoInput, env: Mapping\[str, Any\]\) -> Any:/);
...
assert.equal(pythonMappedOutput.sourceMap.mappings.some((mapping) => mapping.semanticNodeId === 'effect_persist'), true);
assert.equal(pythonMappedOutput.sourceMap.mappings.some((mapping) => mapping.semanticNodeId === 'extern_persist'), true);
...
assert.match(cMappedOutput.code, /#define PERSIST_TODO_EFFECT_CAPABILITY "storage\.write"/);
assert.match(cMappedOutput.code, /frontier_json_value run_PersistTodo_effect\(frontier_effect_env \* env, TodoInput input\)/);
assert.match(cMappedOutput.code, /#define PERSIST_TODO_EXTERN_SYMBOL "persistTodo"/);
assert.match(cMappedOutput.code, /#define PERSIST_TODO_EXTERN_LANGUAGE "typescript"/);
assert.match(cMappedOutput.code, /frontier_json_value call_persistTodo_extern\(frontier_extern_env \* env, TodoInput input\)/);
...
assert.equal(cMappedOutput.sourceMap.mappings.some((mapping) => mapping.semanticNodeId === 'effect_persist'), true);
assert.equal(cMappedOutput.sourceMap.mappings.some((mapping) => mapping.semanticNodeId === 'extern_persist'), true);
