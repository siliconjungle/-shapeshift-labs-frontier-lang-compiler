...
type ExpectedPublicRuntimeExport =
  ...
  | 'createUniversalRuntimeCapabilityMatrix' | 'createUniversalOwnershipConstraintEvidence' | 'createUniversalResourceTransferEvidence'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
