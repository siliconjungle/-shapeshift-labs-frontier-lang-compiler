...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalBorrowCheckerConstraintStatuses' | 'UniversalBorrowScopeConstraintStatuses' | 'UniversalControlFlowConstraintStatuses' | 'UniversalDataLayoutConstraintStatuses' | 'UniversalConcurrencyModelConstraintStatuses' | 'UniversalEffectConstraintStatuses' | 'UniversalErrorModelConstraintStatuses' | 'UniversalEvaluationModelConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalMemoryModelConstraintStatuses' | 'UniversalMetaprogrammingConstraintStatuses' | 'UniversalScopeBindingConstraintStatuses' | 'UniversalModuleConstraintStatuses' | 'UniversalObjectModelConstraintStatuses' | 'UniversalTypeConstraintStatuses'
  ...
  | 'createUniversalRuntimeCapabilityMatrix' | 'createUniversalBorrowCheckerConstraintEvidence' | 'createUniversalBorrowScopeConstraintEvidence' | 'createUniversalControlFlowConstraintEvidence' | 'createUniversalDataLayoutConstraintEvidence' | 'createUniversalConcurrencyModelConstraintEvidence' | 'createUniversalEffectConstraintEvidence' | 'createUniversalErrorModelConstraintEvidence' | 'createUniversalEvaluationModelConstraintEvidence' | 'createUniversalLifetimeConstraintEvidence' | 'createUniversalMemoryModelConstraintEvidence' | 'createUniversalMetaprogrammingConstraintEvidence' | 'createUniversalScopeBindingConstraintEvidence' | 'createUniversalModuleConstraintEvidence' | 'createUniversalObjectModelConstraintEvidence' | 'createUniversalTypeConstraintEvidence' | 'createUniversalOwnershipConstraintEvidence' | 'createUniversalResourceTransferEvidence'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'borrowCheckerConstraintMatches' | 'borrowScopeConstraintMatches' | 'controlFlowConstraintMatches' | 'dataLayoutConstraintMatches' | 'concurrencyModelConstraintMatches' | 'effectConstraintMatches' | 'errorModelConstraintMatches' | 'evaluationModelConstraintMatches' | 'lifetimeConstraintMatches' | 'memoryModelConstraintMatches' | 'metaprogrammingConstraintMatches' | 'scopeBindingConstraintMatches' | 'moduleConstraintMatches' | 'objectModelConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
