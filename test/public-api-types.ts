...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalControlFlowConstraintStatuses' | 'UniversalEffectConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalModuleConstraintStatuses' | 'UniversalTypeConstraintStatuses'
  ...
  | 'createUniversalRuntimeCapabilityMatrix' | 'createUniversalControlFlowConstraintEvidence' | 'createUniversalEffectConstraintEvidence' | 'createUniversalLifetimeConstraintEvidence' | 'createUniversalModuleConstraintEvidence' | 'createUniversalTypeConstraintEvidence' | 'createUniversalOwnershipConstraintEvidence' | 'createUniversalResourceTransferEvidence'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'controlFlowConstraintMatches' | 'effectConstraintMatches' | 'lifetimeConstraintMatches' | 'moduleConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
