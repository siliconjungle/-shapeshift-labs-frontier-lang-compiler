...
type ExpectedPublicRuntimeExport =
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'borrowScopeConstraintMatches' | 'controlFlowConstraintMatches' | 'effectConstraintMatches' | 'lifetimeConstraintMatches' | 'moduleConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
