...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalBorrowCheckerConstraintStatuses' | 'UniversalBorrowScopeConstraintStatuses' | 'UniversalControlFlowConstraintStatuses' | 'UniversalCallableBoundaryConstraintStatuses' | 'UniversalAdtPatternConstraintStatuses' | 'UniversalDataLayoutConstraintStatuses' | 'UniversalLayoutStyleConstraintStatuses' | 'UniversalConcurrencyModelConstraintStatuses' | 'UniversalEffectConstraintStatuses' | 'UniversalErrorModelConstraintStatuses' | 'UniversalEvaluationModelConstraintStatuses' | 'UniversalHostEnvironmentConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalMemoryModelConstraintStatuses' | 'UniversalMetaprogrammingConstraintStatuses' | 'UniversalScopeBindingConstraintStatuses' | 'UniversalModuleConstraintStatuses' | 'UniversalNumericSemanticsConstraintStatuses' | 'UniversalTextSemanticsConstraintStatuses' | 'UniversalCollectionSemanticsConstraintStatuses' | 'UniversalSerializationSemanticsConstraintStatuses' | 'UniversalDependencySemanticsConstraintStatuses' | 'UniversalObjectModelConstraintStatuses' | 'UniversalProtocolConstraintStatuses' | 'UniversalTypeConstraintStatuses'
