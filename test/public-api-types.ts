...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalEffectConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalModuleConstraintStatuses' | 'UniversalTypeConstraintStatuses'
  ...
  | 'createUniversalRuntimeCapabilityMatrix' | 'createUniversalEffectConstraintEvidence' | 'createUniversalLifetimeConstraintEvidence' | 'createUniversalModuleConstraintEvidence' | 'createUniversalTypeConstraintEvidence' | 'createUniversalOwnershipConstraintEvidence' | 'createUniversalResourceTransferEvidence'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'effectConstraintMatches' | 'lifetimeConstraintMatches' | 'moduleConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
