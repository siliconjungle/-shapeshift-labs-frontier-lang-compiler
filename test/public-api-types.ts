...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalEffectConstraintStatuses' | 'UniversalLifetimeConstraintStatuses'
  ...
  | 'createUniversalRuntimeCapabilityMatrix' | 'createUniversalEffectConstraintEvidence' | 'createUniversalLifetimeConstraintEvidence' | 'createUniversalOwnershipConstraintEvidence' | 'createUniversalResourceTransferEvidence'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'effectConstraintMatches' | 'lifetimeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
