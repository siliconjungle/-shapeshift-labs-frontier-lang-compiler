...
type ExpectedPublicRuntimeExport =
  ...
  | 'queryUniversalConversionArtifacts' | 'queryUniversalConversionPlan' | 'queryUniversalConversionWorklist' | 'queryUniversalRuntimeCapabilityMatrix' | 'runtimeProofObligationMatches' | 'runtimeProofSignalsForCapability' | 'UniversalConversionWorkItemKinds'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'borrowCheckerConstraintMatches' | 'borrowScopeConstraintMatches' | 'controlFlowConstraintMatches' | 'callableBoundaryConstraintMatches' | 'adtPatternConstraintMatches' | 'dataLayoutConstraintMatches' | 'concurrencyModelConstraintMatches' | 'effectConstraintMatches' | 'errorModelConstraintMatches' | 'evaluationModelConstraintMatches' | 'hostEnvironmentConstraintMatches' | 'lifetimeConstraintMatches' | 'memoryModelConstraintMatches' | 'metaprogrammingConstraintMatches' | 'scopeBindingConstraintMatches' | 'moduleConstraintMatches' | 'numericSemanticsConstraintMatches' | 'textSemanticsConstraintMatches' | 'collectionSemanticsConstraintMatches' | 'serializationSemanticsConstraintMatches' | 'dependencySemanticsConstraintMatches' | 'objectModelConstraintMatches' | 'protocolConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
  ...
  | 'summarizeRuntimeProofObligations' | 'summarizeUniversalDialectRegistry'
  | 'testSemanticSlice'
...
}); typedNumericSemantics.status satisfies compilerApi.UniversalNumericSemanticsConstraintStatus; typedNumericSemantics.claims.semanticEquivalenceClaim satisfies false; compilerApi.numericSemanticsConstraintMatches(typedNumericSemantics, { numericSemanticsConstraintMissingKind: 'overflow-behavior' }) satisfies boolean; void typedNumericSemantics;
const typedTextSemantics = compilerApi.createUniversalTextSemanticsConstraintEvidence({ sourceLanguage: 'rust', target: 'typescript', sourceTextSemanticsRecords: [{ kind: 'unicode string regex', encoding: 'utf-8', normalizationForm: 'nfc' }] }); typedTextSemantics.status satisfies compilerApi.UniversalTextSemanticsConstraintStatus; typedTextSemantics.claims.semanticEquivalenceClaim satisfies false; compilerApi.textSemanticsConstraintMatches(typedTextSemantics, { textSemanticsConstraintMissingKind: 'normalization' }) satisfies boolean; void typedTextSemantics;
const typedCollectionSemantics = compilerApi.createUniversalCollectionSemanticsConstraintEvidence({ sourceLanguage: 'rust', target: 'typescript', sourceCollectionSemanticsRecords: [{ kind: 'map iterator hash', constraintKinds: ['map-key-semantics', 'hash-semantics'] }] }); typedCollectionSemantics.status satisfies compilerApi.UniversalCollectionSemanticsConstraintStatus; typedCollectionSemantics.claims.semanticEquivalenceClaim satisfies false; compilerApi.collectionSemanticsConstraintMatches(typedCollectionSemantics, { collectionSemanticsConstraintMissingKind: 'hash-semantics' }) satisfies boolean; void typedCollectionSemantics;
const typedSerializationSemantics = compilerApi.createUniversalSerializationSemanticsConstraintEvidence({ sourceLanguage: 'rust', target: 'typescript', sourceSerializationSemanticsRecords: [{ kind: 'json schema canonical roundtrip', constraintKinds: ['field-naming', 'canonicalization', 'roundtrip-stability'] }] }); typedSerializationSemantics.status satisfies compilerApi.UniversalSerializationSemanticsConstraintStatus; typedSerializationSemantics.claims.semanticEquivalenceClaim satisfies false; compilerApi.serializationSemanticsConstraintMatches(typedSerializationSemantics, { serializationSemanticsConstraintMissingKind: 'canonicalization' }) satisfies boolean; void typedSerializationSemantics;
const typedDependencySemantics = compilerApi.createUniversalDependencySemanticsConstraintEvidence({ sourceLanguage: 'typescript', target: 'rust', sourceDependencySemanticsRecords: ['lockfile-integrity', { kind: 'npm package-lock peer dependency integrity', manifestName: 'package.json', managerName: 'pnpm', constraintKinds: ['package-manager', 'lockfile-integrity', 'peer-dependency'] }] }); typedDependencySemantics.status satisfies compilerApi.UniversalDependencySemanticsConstraintStatus; typedDependencySemantics.claims.semanticEquivalenceClaim satisfies false; compilerApi.dependencySemanticsConstraintMatches(typedDependencySemantics, { dependencySemanticsConstraintMissingKind: 'lockfile-integrity' }) satisfies boolean; void typedDependencySemantics;
