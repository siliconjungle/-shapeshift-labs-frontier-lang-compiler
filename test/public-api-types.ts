...
type ExpectedPublicRuntimeExport =
  ...
  | 'createJsTsProjectMergeDeclarationEmitParityProof' | 'createJsTsProjectMergeDeclarationGate' | 'createJsTsProjectMergeDiagnosticsGate' | 'createJsTsProjectReferenceCompositeProof' | 'createJsxSemanticMergeEvidence' | 'createSvgSemanticMergeEvidence'
  ...
  | 'parseJsxSemanticTree' | 'parseSvgSemanticTree'
  | 'queryLanguageAdapterPackageContracts' | 'queryJsxElementRecords'
  ...
  | 'summarizeNativeImportLosses' | 'summarizeSvgSemanticTree'
