...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalBorrowCheckerConstraintStatuses' | 'UniversalBorrowScopeConstraintStatuses' | 'UniversalControlFlowConstraintStatuses' | 'UniversalEffectConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalMemoryModelConstraintStatuses' | 'UniversalModuleConstraintStatuses' | 'UniversalTypeConstraintStatuses'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'borrowCheckerConstraintMatches' | 'borrowScopeConstraintMatches' | 'controlFlowConstraintMatches' | 'effectConstraintMatches' | 'lifetimeConstraintMatches' | 'memoryModelConstraintMatches' | 'moduleConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
