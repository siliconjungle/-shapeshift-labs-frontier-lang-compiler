...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalBorrowCheckerConstraintStatuses' | 'UniversalBorrowScopeConstraintStatuses' | 'UniversalControlFlowConstraintStatuses' | 'UniversalDataLayoutConstraintStatuses' | 'UniversalConcurrencyModelConstraintStatuses' | 'UniversalEffectConstraintStatuses' | 'UniversalErrorModelConstraintStatuses' | 'UniversalEvaluationModelConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalMemoryModelConstraintStatuses' | 'UniversalMetaprogrammingConstraintStatuses' | 'UniversalModuleConstraintStatuses' | 'UniversalObjectModelConstraintStatuses' | 'UniversalTypeConstraintStatuses'
