...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalBorrowCheckerConstraintStatuses' | 'UniversalBorrowScopeConstraintStatuses' | 'UniversalControlFlowConstraintStatuses' | 'UniversalEffectConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalModuleConstraintStatuses' | 'UniversalTypeConstraintStatuses'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'borrowCheckerConstraintMatches' | 'borrowScopeConstraintMatches' | 'controlFlowConstraintMatches' | 'effectConstraintMatches' | 'lifetimeConstraintMatches' | 'moduleConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
