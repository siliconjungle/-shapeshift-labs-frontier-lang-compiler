...
type ExpectedPublicRuntimeExport =
  ...
  | 'createJsTsProjectMergeDeclarationEmitParityProof' | 'createJsTsProjectMergeDeclarationGate' | 'createJsTsProjectMergeDiagnosticsGate' | 'createJsTsProjectReferenceCompositeProof' | 'createJsxSemanticMergeEvidence' | 'createSvgSemanticMergeEvidence' | 'createPackageManifestSemanticMergeEvidence'
  ...
  | 'parseJsxSemanticTree' | 'parseSvgSemanticTree' | 'parsePackageManifestSemanticTree'
  | 'queryLanguageAdapterPackageContracts' | 'queryJsxElementRecords' | 'queryPackageDependencyRecords'
  ...
  | 'summarizeNativeImportLosses' | 'summarizeSvgSemanticTree' | 'summarizePackageManifestSemanticTree'
