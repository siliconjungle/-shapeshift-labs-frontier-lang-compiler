...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions'
  | 'UniversalInterlinguaLayerKinds' | 'UniversalInterlinguaLoweringDispositions'
  | 'UniversalRepresentationConstructKinds' | 'UniversalResourceTransferStatuses' | 'UniversalRuntimeCapabilityKinds'
  ...
  | 'createUniversalRuntimeCapabilityMatrix' | 'createUniversalResourceTransferEvidence'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'interlinguaRecordMatches'
