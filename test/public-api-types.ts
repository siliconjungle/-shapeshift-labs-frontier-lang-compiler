...
type ExpectedPublicRuntimeExport =
  ...
  | 'UniversalDialectConstructKinds' | 'UniversalDialectProjectionDispositions' | 'UniversalEffectConstraintStatuses' | 'UniversalLifetimeConstraintStatuses' | 'UniversalTypeConstraintStatuses'
  ...
  | 'createUniversalRuntimeCapabilityMatrix' | 'createUniversalEffectConstraintEvidence' | 'createUniversalLifetimeConstraintEvidence' | 'createUniversalTypeConstraintEvidence' | 'createUniversalOwnershipConstraintEvidence' | 'createUniversalResourceTransferEvidence'
  ...
  | 'representationCoverageMatches' | 'resourceTransferMatches' | 'effectConstraintMatches' | 'lifetimeConstraintMatches' | 'typeConstraintMatches' | 'ownershipConstraintMatches' | 'interlinguaRecordMatches'
