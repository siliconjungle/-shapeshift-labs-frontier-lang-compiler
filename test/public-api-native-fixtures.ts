...
import { createProjectImportAdmissionRecord, createProjectionReadinessMatrix, createSemanticSliceAdmissionRecord, createUniversalConversionArtifacts, createUniversalConversionPlan, createUniversalConversionWorklist, createUniversalDialectRegistry, queryProjectionReadinessMatrix, queryUniversalCapabilityMatrix, queryUniversalConversionArtifacts, queryUniversalConversionPlan, UniversalConversionWorkItemKinds } from '../src/index.js';
...
const conversionWorklistTypes: UniversalConversionWorklist = createUniversalConversionWorklist(conversionPlanTypes, {
  target: 'javascript'
});
