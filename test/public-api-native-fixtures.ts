...
import { createProjectImportAdmissionRecord, createProjectionReadinessMatrix, createUniversalDialectRegistry, queryProjectionReadinessMatrix } from '../src/index.js';
