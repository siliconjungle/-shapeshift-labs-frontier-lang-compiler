...
| P1 | Nested/scoped CSS parser-backed expansion | Current nested/scoped CSS admission still blocks unsafe nesting without parser-backed expansion and declaration-span proof. | Parser-backed nesting expansion fixture family with source-bound declaration spans and stale expansion rejection. |
