...
| JSX/TSX prop graph | high | Prop values, spread props, static spread effective-prop commutation, component prop contracts, prop flows, static event-handler source-preservation proofs, and dynamic blockers are covered. | Add more component corpus cases as new framework prop-flow families are admitted. |
